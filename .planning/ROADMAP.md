...
- [x] 03-02-PLAN.md — GemTable UI component with columns, position filter, page.tsx wiring
...
Plans:
- [x] 04-01-PLAN.md — Fix defensive_contribution bug, DefConPlayer type, pipeline/defcon.py, run.py integration
- [x] 04-02-PLAN.md — TDD: DefCon TypeScript utility functions (thresholds, splitting, formatting)
- [x] 04-03-PLAN.md — /api/defcon route, useDefCon hook, DefConTables UI, page.tsx tab navigation
...
- [x] 05-03-PLAN.md — SquadView + TransferPanel UI components, page.tsx tab wiring
