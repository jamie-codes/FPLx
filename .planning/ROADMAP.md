...
- [ ] **Phase 86: Data Health Dashboard** — `data_health.json` artifact (DH-01), `/api/data-health` route + `useDataHealth` hook (DH-03), collapsible AccuracyTab panel (DH-02)
- [ ] **Phase 87: Set-Piece Delivery Pipeline** — Understat per-team shot scrape with `player_assisted` aggregation (SPQ-01), `sp_quality.json` corner/FK danger scores with EB shrinkage (SPQ-02)
...
| 86 | v1.15 | 0 | Not started | - |
| 87 | v1.15 | 0 | Not started | - |
