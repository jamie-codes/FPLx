# Requirements Archive: v1.1 Decision Engine
...
- [x] **MINS-03**: Transfer suggestions de-prioritise rotation risk players relative to gem score
...
- [x] **AUTH-01**: User can log in with FPL credentials to unlock exact bank balance and sell prices
- [x] **AUTH-02**: User can see exact selling price from my-team endpoint when authenticated
