...
describe('Phase 36: page.tsx state', () => {
  ...
  it('Plan section sub-tab nav contains "Manual Plan" after "Planner" (D-01, MTP-01)', () => {
    ...
    // Order locked by D-01 + D-05/D-06: Manual Plan after Planner, Route Tree after Manual Plan, Rank Sim after Route Tree (Phase 62 MC-03), Club Form moved to Analyse (Phase 97 D-02), Next Season after Rivals (Phase 126 NSP-04), Watchlist after Next Season (Phase 127 WATCH-04), Wildcard after Watchlist (WC-01)
    expect(subTabBtns).toEqual(['Planner', 'Manual Plan', 'Route Tree', 'Rank Sim', 'Value Gems', 'Rivals', 'Next Season', 'Watchlist', 'Wildcard'])
  })
  ...
  it('inserts Route Tree sub-tab after Manual Plan in Plan section nav (D-05/D-06)', () => {
    ...
    // Sub-tab order: Planner | Manual Plan | Route Tree | Rank Sim | Value Gems | Rivals | Next Season | Watchlist | Wildcard (WC-01)
