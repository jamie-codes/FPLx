  ...
  versions: [
    {
      ...
      hit_rate: 0.380,
      gate_flags: { form_signal_enabled: false, xmins_v2_enabled: false, bonus_predictor_enabled: false, save_predictor_enabled: false },
    },
    {
      formula_version: 'v1.12-a',
      recorded_at: '2026-04-30T00:00:00+00:00',
      hit_rate: 0.420,
      gate_flags: { form_signal_enabled: true, xmins_v2_enabled: false, bonus_predictor_enabled: false, save_predictor_enabled: false },
    },
  ],
  calibration: {
    by_position: {
